...
export const ResultsList = ({
  ...
  return (
    <div>
      {/* Error */}
      {error && (
        <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 text-red-700 dark:text-red-400 rounded px-3 py-2 text-sm mb-3 whitespace-pre-line">
          {error}
        </div>
      )}
