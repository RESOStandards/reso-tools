    ...
    <div className="h-screen flex flex-col overflow-hidden bg-gray-50 dark:bg-gray-900 transition-colors">
      ...
      <div className="flex flex-1 overflow-hidden relative">
        ...
        `}>
          ...
          <div className="shrink-0 border-t border-gray-200 dark:border-gray-700 px-4 py-2.5">
            <a
              href="https://www.reso.org/eula/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-[11px] text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 transition-colors">
              Terms of Use
            </a>
          </div>
        </nav>
