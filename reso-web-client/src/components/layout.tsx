    ...
    <div className="h-screen flex flex-col overflow-hidden bg-gray-50 dark:bg-gray-900 transition-colors">
      ...
      <header className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-4 py-3 sm:px-6">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
          {/* Cert workspace link removed — the cert UI is accessed
              through the Organizations directory "View Summary" flow
              or directly via /cert/orgs/:uoi. The top-nav entry was
              removed to simplify the header for the OData browser
              layout which is the primary use case of this shell. */}
          {/* Update badge */}
          {availableUpdate && (
            <a
