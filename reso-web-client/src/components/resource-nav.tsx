...
export const ResourceNav = () => {
  ...
  const activeSection: Section =
    ...
    : location.pathname.startsWith('/cert') ? 'certification'
  ...
  return (
    <div className="flex flex-col gap-1.5">
      {/* Data exploration: Dashboard, Resources, Metadata */}
              ...
              return (
                <li key={resource}>
                  <NavLink
                    ...
                    {resource}
                    {isReadOnly && (
                      <span title="Read-only resource" className="ml-1 text-gray-400 dark:text-gray-500 inline-block align-middle">
      ...
      {/* Admin items — flat, conditional on local server. The label uses
          the same sectionHeaderClass shape as the other section headers
