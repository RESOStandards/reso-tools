...
describe('validateCsdlXml – valid documents', () => {
  it('validates a minimal OData 4.0 CSDL document', () => {
...
<edmx:Edmx Version="4.0" xmlns:edmx="http://docs.oasis-open.org/odata/ns/edmx">
  <edmx:DataServices>
    ...
    const result = validateCsdlXml(csdl);
    expect(result.valid).toBe(true);
    expect(result.odataVersion).toBe('4.0');
    expect(result.errors).toHaveLength(0);
  });

  it('validates a minimal OData 4.01 CSDL document', () => {
    const csdl = `<?xml version="1.0" encoding="utf-8"?>
<edmx:Edmx Version="4.01" xmlns:edmx="http://docs.oasis-open.org/odata/ns/edmx">
  ...
  it('validates CSDL with EnumType', () => {
    const csdl = `<?xml version="1.0" encoding="utf-8"?>
<edmx:Edmx Version="4.0" xmlns:edmx="http://docs.oasis-open.org/odata/ns/edmx">
  <edmx:DataServices>
    <Schema Namespace="Test" xmlns="http://docs.oasis-open.org/odata/ns/edm">
  ...
  it('validates CSDL with EntityContainer and EntitySet', () => {
    const csdl = `<?xml version="1.0" encoding="utf-8"?>
<edmx:Edmx Version="4.0" xmlns:edmx="http://docs.oasis-open.org/odata/ns/edmx">
  <edmx:DataServices>
    <Schema Namespace="Test" xmlns="http://docs.oasis-open.org/odata/ns/edm">
...
<edmx:Edmx Version="4.0" xmlns:edmx="http://docs.oasis-open.org/odata/ns/edmx">
  <edmx:DataServices>
    ...
    const result = validateCsdlXml(csdl, '4.0');
    expect(result.valid).toBe(true);
    expect(result.odataVersion).toBe('4.0');
  });
});
...
describe('validateCsdlXml – invalid documents', () => {
  it('rejects a bogus element inside Schema', () => {
    const csdl = `<?xml version="1.0" encoding="utf-8"?>
<edmx:Edmx Version="4.01" xmlns:edmx="http://docs.oasis-open.org/odata/ns/edmx">
  <edmx:DataServices>
    <Schema Namespace="Test" xmlns="http://docs.oasis-open.org/odata/ns/edm">
  ...
  it('rejects missing DataServices', () => {
    const csdl = `<?xml version="1.0" encoding="utf-8"?>
<edmx:Edmx Version="4.0" xmlns:edmx="http://docs.oasis-open.org/odata/ns/edmx">
</edmx:Edmx>`;
    const result = validateCsdlXml(csdl);
...
<edmx:Edmx xmlns:edmx="http://docs.oasis-open.org/odata/ns/edmx">
  ...
  it('rejects Property with missing Type attribute', () => {
    const csdl = `<?xml version="1.0" encoding="utf-8"?>
<edmx:Edmx Version="4.0" xmlns:edmx="http://docs.oasis-open.org/odata/ns/edmx">
  <edmx:DataServices>
    <Schema Namespace="Test" xmlns="http://docs.oasis-open.org/odata/ns/edm">
  ...
  it('rejects invalid OData version number', () => {
    const csdl = `<?xml version="1.0" encoding="utf-8"?>
...
describe('Commander test fixtures', () => {
  it('bad-edmx-no-keyfield.xml: structurally valid (Key is optional in XSD)', () => {
    const xml = readFileSync(join(FIXTURES, 'bad-edmx-no-keyfield.xml'), 'utf-8');
    const result = validateCsdlXml(xml);
  ...
  it('bad-edmx-wrong-edm-binding-target.xml: structurally valid (binding target is semantic)', () => {
  ...
  it('bad-edmx-unparsable-xml.xml: throws on malformed XML', () => {
