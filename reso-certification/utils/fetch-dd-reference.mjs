 ...
 * subpath export; the desktop client packages the same files from the published reso-common).
 * This script writes the live JSON from transport into reso-common/reference-metadata/dd-{ver}.json,
...
const targets = (version) => [`reso-common/reference-metadata/dd-${version}.json`];
